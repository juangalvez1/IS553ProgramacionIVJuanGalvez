...
#     sistemaTemp.flota.clear()
#     cargados = 0
    
#     for tipo, lista in datos.items():
#         for v in lista:
#             placa = v["placa"].upper()
#             if placa in sistemaTemp.flota:
#                 print(f"    Placa duplicada '{placa}' ignorada.")
#                 continue
#             sistemaTemp.flota[placa] = sistemaTemp.__leerVehiculo(tipo, v)
#             cargados += 1
#     print(f"    {cargados} vehículo(s) cargados en memoria.")

#     precioMasAlto = -1

#     for v in sistemaTemp.flota.values():
#         if v["precioPorDia"] > precioMasAlto:
#             precioMasAlto = v["precioPorDia"]
#             VehiculoCostoso = v

#     if precioMasAlto == -1:
#         print("No hay vehiculos registrados en el sistema.")
#     else:
#         print("El vehiculo mas costoso de alquilar es:")
#         print(VehiculoCostoso)